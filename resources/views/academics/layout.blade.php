        ...
        <div class="row">
          <div class="col-12">
              <div class="owl-slide-3 owl-carousel">
                  ...
                  <div class="course-1-item">
                    <figure class="thumnail">
                        <a href="{{route('single')}}"><img src="images/course_4.jpg" alt="Image" class="img-fluid"></a>
                      <div class="price">$99.00</div>
                      <div class="category"><h3>Mobile Application</h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
                  ...
                  <div class="course-1-item">
                    <figure class="thumnail">
                        <a href="{{route('single')}}"><img src="images/course_5.jpg" alt="Image" class="img-fluid"></a>
                      <div class="price">$99.00</div>
                      <div class="category"><h3>Web Design</h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
                  ...
                  <div class="course-1-item">
                    <figure class="thumnail">
                        <a href=""><img src="images/course_6.jpg" alt="Image" class="img-fluid"></a>
                      <div class="price">$99.00</div>
                      <div class="category"><h3>Mobile Application</h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
